...
# <./myproj/RTL.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project RTL/RTL [lindex $argv 0] -part xczu3eg-sbva484-1-e
...
# CHECK IPs
##################################################################
set_property  ip_repo_paths ./HLS/solution1/impl/ip [current_project]
update_ip_catalog
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {333.000} \
  ...
  connect_bd_intf_net -intf_net smartconnect_2_M00_AXI [get_bd_intf_pins ps_e/S_AXI_HP3_FPD] [get_bd_intf_pins smartconnect_2/M00_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins SkyNet/ap_clk] [get_bd_pins SkyNet_connect/ACLK] [get_bd_pins SkyNet_connect/M00_ACLK] [get_bd_pins SkyNet_connect/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm1_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins ps_e/saxihp3_fpd_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_2/aclk]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins SkyNet/ap_rst_n] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins smartconnect_2/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps_e/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins ps_e/pl_resetn0]
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces SkyNet/Data_m_axi_fm] [get_bd_addr_segs ps_e/SAXIGP3/HP1_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces SkyNet/Data_m_axi_wt] [get_bd_addr_segs ps_e/SAXIGP2/HP0_LPS_OCM]
...
##################################################################
create_root_design ""
make_wrapper -files [get_files ./RTL/RTL.srcs/sources_1/bd/ultra96v2/ultra96v2.bd] -top
add_files -norecurse ./RTL/RTL.srcs/sources_1/bd/ultra96v2/hdl/ultra96v2_wrapper.v
